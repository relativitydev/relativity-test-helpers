...
namespace Relativity.Test.Helpers.Application
{
	...
	{
		public static Int32 ImportApplication(IRSAPIClient client, Int32 workspaceId, bool forceFlag, string filePath, int appArtifactID = -1)
		{
			int artifactID = 0;
			...
			query.Condition = new kCura.Relativity.Client.TextCondition(RelativityApplicationFieldNames.Name, kCura.Relativity.Client.TextConditionEnum.EqualTo, "Admin Migration Utility");
